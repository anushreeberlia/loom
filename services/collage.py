...
LAYOUT_SLOTS = {
    ...
    "layer": ["top", "bottom", "shoes", "layer"],  # Layer input: top|bottom, shoes|layer(input)
...
def create_grid_collage(
    ...
    # When input is a layer (jacket, coat, etc)
    if base_category == "layer":
        ...
        custom_positions = {
            ...
            "bottom": (CELL_SIZE, 0),           # Top-right
            "shoes": (0, CELL_SIZE),            # Bottom-left
            "layer": (CELL_SIZE, CELL_SIZE),    # Bottom-right (input)
        }
    ...
    if has_layer and "layer" not in layout_slots and base_category in ["top", "bottom"]:
        ...
        # TOP    | BOTTOM
        # SHOES  | LAYER
        layout_slots = ["top", "bottom", "shoes", "layer"]
        custom_positions = {
            "top": (0, 0),                      # Top-left (always)
            "bottom": (CELL_SIZE, 0),           # Top-right (always)
            "shoes": (0, CELL_SIZE),            # Bottom-left
